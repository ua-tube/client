import { defaultVideo, qualities } from '@/data/video'
...
const videoEdits: IVideo[] = [
	...
	},
	{
		...
		channel: {
			...
			id: 'Sia',
			profileImg:
				'https://i.pinimg.com/564x/16/4d/f5/6354c215a3c641a37ca7e4759da038ee.jpg',
			nickName: 'sia'
		}
	},
	{
	...
	},
	{
		...
		channel: {
			...
			nickName: 'molob',
			profileImg:
				'https://yt3.ggpht.com/vqRn33QWEAp2NGudzu_OPVLOEUK-qUkdYhLRyZ5cZQKqzrdMA1mDVclcMmhkmGF14hGT1EXkEQ=s68-c-k-c0x00ffffff-no-rj'
		}
	},
	{
