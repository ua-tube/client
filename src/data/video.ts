...
const defaultVideo: IVideo = {
	...
	description:
		'Let me know which track you would like next from NightDrive Part 2\n' +
		'Mix:   \n' +
		'\n' +
	...
	creator: {
		...
		name: 'Bones - тема',
		profileImg:
			'https://yt3.ggpht.com/odyoGI3JugwocJD-Nmw64lzDgngCJctgDKOM750RuIlIu759W7Cir9BJprZwaEsHmmIZTjU6Oa8=s48-c-k-c0x00ffffff-no-rj',
...
const defaultComments: IComment[] = [
	{
		...
		chanel: {
			...
			profileImg:
				'https://yt3.ggpht.com/ytc/AIf8zZTx3AsZckgO7PrxzDER6nPqydPP_EsO6XIxoRWxHg=s48-c-k-c0x00ffffff-no-rj',
			subscribersCount: 10000
		},
		children: [
			{
	...
	},
	{
		...
		chanel: {
			...
			name: 'Кулінарія',
			profileImg:
				'https://yt3.ggpht.com/bM56yGtmL91Ks0iQoKtuVxDGXBxqlOcJFXbNgAGieneif3kVGefYulz4gr3RBN-5XMvfHUDP3Q=s48-c-k-c0x00ffffff-no-rj',
	...
	},
	{
		...
		chanel: {
			...
			name: 'Подорожі',
			profileImg:
				'https://yt3.ggpht.com/uuuDF5kog8igvdBOJcXjfTD2F059JI19ItkriqAlayoc3RRIUswwYPHZGWHJqZvanRaBa9bS8w=s48-c-k-c0x00ffffff-no-rj',
	...
	},
	{
		...
		chanel: {
			...
			name: 'Музика',
			profileImg:
				'https://yt3.ggpht.com/CodCq1P96PEMlEOz3VigJnJy3Jsq8JUoDOKEhrmC6WN0W-yUNgymV5mrXG-iKFRmm6JgYB02GA=s48-c-k-c0x00ffffff-no-rj',
	...
	},
	{
		...
		chanel: {
			...
			name: 'Спорт',
			profileImg:
				'https://yt3.ggpht.com/r5xAvOWzSZOExIfJ4J7pd7rQC_TC8M2kGu_TDZAPQiUtUkT3K08CXPN1mVqk3EP28TGp0G3W=s48-c-k-c0x00ffffff-no-rj',
...
const defaultChannel: IChannel = {
	...
	profileBgImg:
		'https://yt3.googleusercontent.com/-N5buVuvnKvpDu1s71G-2TA5_SFvrvXe49NaHXoRcKDSXq6meEcoYm1F5Cq0cwyQ9s-KLZBJiw=w1707-fcrop64=1,00005a57ffffa5a8-k-c0xffffffff-no-nd-rj',
	profileImg:
		'https://yt3.googleusercontent.com/yCY69HQl8LRBKHaVZZwLYF84TOr9ydQGz_AkSJFWFIHpoTUsCD0InDkrlZgY7kpTpEG3ChlLnw=s176-c-k-c0x00ffffff-no-rj'
}
