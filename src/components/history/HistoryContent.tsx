...
const HistoryContent: FC = () => {
	...
	return (
		<section className='mx-auto max-w-[90rem] flex flex-col gap-6 lg:gap-8 md:flex-row'>
			<div className='space-y-10 w-full lg:w-3/4 '>
				...
				{currHistory.length > 0 ? (
					<div
						className='space-y-3'
						children={currHistory.map((value, index) => (
							<div key={index}>
								<h2
									className='scroll-m-20 border-b pb-2 mb-4 text-3xl font-semibold tracking-tight first:mt-0 sticky top-0 bg-background z-10'
