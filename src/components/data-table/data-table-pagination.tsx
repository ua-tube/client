import { Button, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, DynamicIcon } from '@/components'
			...
			<div className="flex items-center space-x-6 lg:space-x-8">
				<div className="flex items-center space-x-2">
					...
					>
						...
						<SelectContent side="top" children={
							[10, 20, 30, 40, 50].map((pageSize) => (
								<SelectItem key={pageSize} value={`${pageSize}`} children={pageSize} />
							))}
						/>
					</Select>
				</div>
