	...
	return <Card className='break-inside mb-2'>
		...
		<CardContent>
			<div
				...
				children={
					videos.slice(0, 5).map((value, index) =>
						<div key={index} className="group flex flex-row items-center space-x-3 pt-1">
							...
							<div className="relative">
								...
								<div
									className="absolute bg-background left-0 top-0 size-full opacity-0 group-hover:opacity-100 flex items-center space-x-4"
								>
									<Link
