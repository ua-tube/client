	...
	return <div className='space-y-2'>
			...
			<div className="flex flex-col md:flex-row gap-4 items-start py-2">
				...
				<div className="w-1/3 space-y-2">
					<p className="flex max-w-md text-sm">
						Радимо використовувати зображення розміром принаймні 98 x 98 пікселів
						(розмір файлу – до 4 МБ) у форматі PNG або GIF (без анімації).
						Пам'ятайте, що воно має відповідати правилам спільноти UaTube.
					</p>
		...
		<div>
			...
			<div className="flex flex-col md:flex-row gap-4 items-start py-2">
				...
				<div className="w-1/3 space-y-2">
					<p className="flex max-w-md text-sm">
						Щоб банер мав гарний вигляд на всіх пристроях,
						використовуйте зображення розміром принаймні 2028 x
						1152 пікселів	(розмір файлу – до 5 МБ).
					</p>
					<div className="flex items-center gap-x-2">
						<Button children="Змінити" variant="secondary" />
						<Button children="Вилучити" variant="secondary" />
