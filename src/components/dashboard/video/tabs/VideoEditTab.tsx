				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>
								Приваблива назва допоможе зацікавити глядачів. Додайте в назви
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>
								Описи з ключовими словами допомагають глядачам знаходити ваші
								відео через пошук. Напишіть, про що ваше відео, використовуючи
								ключові слова на початку опису.
							</FormDescription>
							<FormControl>
												...
												!customFile ? (
													...
													<div className='relative group aspect-video'>
														<img
															...
															alt='0'
														/>
														<div className='absolute bottom-0 right-0 size-full opacity-0 group-hover:opacity-100'>
															<Button
																variant='destructive'
