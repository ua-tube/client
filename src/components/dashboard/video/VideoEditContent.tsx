...
const VideoEditTab = dynamic(() => import('@/components/dashboard/video/tabs/VideoEditTab'))
const VideoAnalyticsTab = dynamic(() => import('@/components/dashboard/video/tabs/VideoAnalyticsTab'))
const VideoCommentsTab = dynamic(() => import('@/components/dashboard/video/tabs/VideoCommentsTab'))
