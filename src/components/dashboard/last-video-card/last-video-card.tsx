import { Card, CardHeader, CardTitle, CardContent, Separator, buttonVariants, DynamicIcon } from '@/components'
...
const DashboardLastVideoCard: FC = () => {
	...
	return <Card className='break-inside mb-2'>
		...
		<CardContent>
			<Link href={getDashboardVideoUrl(video.id, 'analytics')} className="relative aspect-video">
				<img
			...
			<Link
				...
				className={cn(buttonVariants({ variant: 'secondary' }), 'text-lg hover:underline w-full mt-1')}
			>
